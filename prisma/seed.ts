...
async function main() {
  const user = await prisma.user.upsert({ where: { email: "efiakedohogideon@gmail.com" }, update: { passwordHash: await hashPassword("PASSWORD_12345") }, create: { name: "Gideon", email: "efiakedohogideon@gmail.com", passwordHash: await hashPassword("PASSWORD_12345") } });
