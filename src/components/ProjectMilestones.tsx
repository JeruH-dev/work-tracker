...
export function ProjectMilestones({ projects }: { projects: Project[] }) {
  ...
  if (!projects.length) return <section className="project-empty-state"><div className="project-empty-icon" aria-hidden="true">◫</div><strong>No projects yet</strong><p>Create your first project to give related tasks, milestones, and outcomes a clear home.</p></section>;
